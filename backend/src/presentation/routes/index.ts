...
contactRouter.get('/', authMiddleware, authorize(UserRole.ADMIN, UserRole.GUEST), contactCtrl.getAll); // Permitir GUEST ver
contactRouter.get('/unread-count', authMiddleware, authorize(UserRole.ADMIN, UserRole.GUEST), contactCtrl.getUnreadCount);
contactRouter.get('/:id', authMiddleware, authorize(UserRole.ADMIN, UserRole.GUEST), contactCtrl.getById);
