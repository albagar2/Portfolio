...
async function main() {
  const projects = [
    ...
    },
    {
      ...
      challenges: 'Renderizado de gráficos de velas (candlestick) de alto rendimiento utilizando Canvas API para manejar miles de puntos de datos sin lag. Conexión estable con APIs de differentes plataformas con protocolos de autenticación variados. Gestión de la consistencia de datos en memoria ante desconexiones de red.',
  ...
  console.log('🌱 Optimizando portafolio para empresas (CJS + Dotenv version)...');
